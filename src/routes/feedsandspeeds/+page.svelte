...
<svelte:head>
	<title>{routes.find((r) => $page.url.pathname.startsWith(r.link))?.title} : Bionic Parts</title>
	<meta
		name="description"
		...
		<div class="card-body">
			...
			<div class="mb-3">
				...
				<div class="input-group mb-3">
					...
					<button
						...
						type="button"
						on:click={() => (toolDiameterIn = 0.125)}
						>.125"
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (toolDiameterIn = 0.25)}
						>.25"
					</button>
					<button class="btn btn-outline-primary" on:click={() => (diameterModalOpen = true)}
						>Details</button
					>
				</div>
			...
			<div class="mb-3">
				...
				<div class="input-group mb-3">
					...
					<button class="btn btn-outline-secondary" type="button" on:click={() => (numFlutes = 1)}
						>1</button
					>
					<button class="btn btn-outline-secondary" type="button" on:click={() => (numFlutes = 2)}
						>2</button
					>
					<button class="btn btn-outline-secondary" type="button" on:click={() => (numFlutes = 3)}
						>3</button
					>
					<button class="btn btn-outline-secondary" type="button" on:click={() => (numFlutes = 4)}
						>4</button
					>
					<button class="btn btn-outline-primary" on:click={() => (flutesModalOpen = true)}
						>Details</button
					>
				</div>
			...
			<div class="mb-3">
				...
				<div class="input-group mb-3">
					...
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (surfaceSpeedFPM = 200)}
						>200
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (surfaceSpeedFPM = 300)}
						>300
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (surfaceSpeedFPM = 400)}
						>400
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (surfaceSpeedFPM = 500)}
						>500
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (surfaceSpeedFPM = 600)}
						>600
					</button>
					<button class="btn btn-outline-primary" on:click={() => (surfaceSpeedModalOpen = true)}
						>Details</button
					>
				</div>
			...
			<div class="mb-3">
				...
				<div class="input-group mb-3">
					...
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (chipLoadIPT = 0.001)}
						>.001"
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (chipLoadIPT = 0.002)}
						>.002"
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (chipLoadIPT = 0.003)}
						>.003"
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (chipLoadIPT = 0.004)}
						>.004"
					</button>
					<button
						class="btn btn-outline-secondary"
						type="button"
						on:click={() => (chipLoadIPT = 0.005)}
						>.005
					</button>
					<button class="btn btn-outline-primary" on:click={() => (chipLoadModalOpen = true)}
						>Details</button
					>
				</div>
			...
			<Results
				machiningParams={calcMachiningPrams({
					toolDiameterIn,
					surfaceSpeedFPM,
					chipLoadIPT,
					numFlutes
