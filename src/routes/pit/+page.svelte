...
<div class="wrapper">
	...
	<div class="row binrow row-fill-height" id="row2" data-name="Rankings and Matches">
		<div class="col">
			<div class="bin">
...
{#if false}
	<div class="wrapper">
		<div class="container-fluid binrow">
			<div class="row" data-name="Logo and Stats">
				<div class="col">
					<a href="/pit/config">
						<img src="bionics-logo.svg" alt="Bionics Logo" class="logo" />
					</a>
						...
						<div class="d-flex align-items-center justify-content-center gap-3">
							<Badge
								value={data.ourRanking
									? Math.round(data.ourRanking.epa.breakdown.auto_points)
									: '?'}
								prefix={'Auto EPA'}
							/>
							<Badge
							...
							<Badge
								value={data.ourRanking
									? Math.round(data.ourRanking.epa.breakdown.total_points)
									: '?'}
								prefix={'Total EPA'}
								color={'rgb(214, 39, 40)'}
							/>
			...
			<div class="row binrow row-fill-height" data-name="Rankings and Matches">
				<div class="col">
					<div class="bin">
						<h4 class="binHeader">Rankings</h4>
						<TableForObjectArray data={data.rankings.sort((a, b) => a.rank - b.rank)} />
				...
				<div class="col">
					<div class="bin">
						...
						<div class="row mb-3">
							<div class="col text-center">
								<span class="fs-4 text-danger">{data.nextmatch?.alliances.red1.number}</span><br
								/>{data.nextmatch?.alliances.red1.epa}
							</div>
							<div class="col text-center">
								<span class="fs-4 text-danger">{data.nextmatch?.alliances.red2.number}</span><br
								/>{data.nextmatch?.alliances.red2.epa}
							</div>
							<div class="col text-center">
								<span class="fs-4 text-danger">{data.nextmatch?.alliances.red3.number}</span><br
								/>{data.nextmatch?.alliances.red3.epa}
							</div>
						</div>
						<div class="row mb-3">
							<!-- <div class="col text-center">
			...
			<div class="row binrow" data-name="Sponsors">
				<div class="col">
					<div class="bin sponsors text-center">
						<h4 class="binHeader">Thank You to our generous sponsors</h4>
						<img src="sponsors/KLA.svg" alt="KLA" />
